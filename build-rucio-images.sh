...
export CMS_VERSION=${RUCIO_VERSION}.yuyi-ca-sleep4
...
sudo docker build --no-cache --build-arg RUCIO_VERSION=$RUCIO_VERSION -f docker/rucio-daemons/Dockerfile -t $HARBOR/rucio-daemons:release-$CMS_VERSION .
